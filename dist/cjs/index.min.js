"use strict";var u=Object.defineProperty;var W=Object.getOwnPropertyDescriptor;var $=Object.getOwnPropertyNames,m=Object.getOwnPropertySymbols;var N=Object.prototype.hasOwnProperty,F=Object.prototype.propertyIsEnumerable;var v=(t,o,e)=>o in t?u(t,o,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[o]=e,d=(t,o)=>{for(var e in o||(o={}))N.call(o,e)&&v(t,e,o[e]);if(m)for(var e of m(o))F.call(o,e)&&v(t,e,o[e]);return t};var k=(t,o)=>{for(var e in o)u(t,e,{get:o[e],enumerable:!0})},G=(t,o,e,s)=>{if(o&&typeof o=="object"||typeof o=="function")for(let n of $(o))!N.call(t,n)&&n!==e&&u(t,n,{get:()=>o[n],enumerable:!(s=W(o,n))||s.enumerable});return t};var K=t=>G(u({},"__esModule",{value:!0}),t);var B={};k(B,{Connect:()=>S,default:()=>q});module.exports=K(B);var f="connectIframe",g="connectStyles",h="iframe",O="web",_="PACKAGE_VERSION";var w="ack",T="cancel",y="url",b="done",I="error",x="ping",C="window",R="route",U="user",A="closePopup";var i,P,p,r,a,c,D,l,Y={onLoad:()=>{},onUser:t=>{},onRoute:t=>{}},S={destroy(){r&&r.parentNode&&r.parentNode.removeChild(r),a&&a.parentNode&&a.parentNode.removeChild(a),!r&&c&&c.close(),r=void 0,a=void 0,window.removeEventListener("message",P)},launch(t,o,e={}){if(p=t,i=d(d({},Y),o),D=new URL(p).origin,e.popup){let s={toolbar:"no",location:"no",status:"no",menubar:"no",width:720,height:520,top:window.self.outerHeight/2+window.self.screenY-720/2,left:window.self.outerWidth/2+window.self.screenX-520/2},n=d(d({},s),e.popupOptions),E=window.open(p,"targetWindow",`toolbar=${s.toolbar},location=${s.location},status=${s.status},menubar=${s.menubar},width=${n.width},height=${n.height},top=${n.top},left=${n.left}`);return E?(c=E,E.focus(),this.initPostMessage(e),i.onLoad&&i.onLoad()):i.onError({reason:"error",code:1403}),E}else{if(r&&r.parentNode)throw new Error('You must destroy the iframe before you can open a new one. Call "destroy()"');if(!document.getElementById(g)){let n=document.createElement("style");n.id=g,n.type="text/css",n.innerHTML=`#${f} {
          position: absolute;
          left: 0;
          top: 0;
          width: 100%;
